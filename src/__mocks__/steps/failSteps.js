...
export const registerFailSteps = PK => {
  ...
  PK.Then(`this step should be skipped`, world => {})

  PK.And(`this step should also be skipped`, world => {})
}
