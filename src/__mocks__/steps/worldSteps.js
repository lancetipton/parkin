export const registerWorldSteps = PK => {
  ...
  PK.Given('that the app url is {string}', (url, world) => {
  ...
  PK.Then('{string} should be replaced', (replaced, world) => {
  ...
  PK.Then('this features status should be {string}', (status, world) => {
