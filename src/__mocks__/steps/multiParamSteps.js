export const registerMultiParamSteps = PK => {
  PK.Given(`I have {int} types of {word} out of a total of {int}`, (typeAmt, type, totalAmt, ctx) => {
  ...
  PK.Then(`there are {int} {string} in the {word} {string}`, (num1, word1, word2, word3, ctx) => {
